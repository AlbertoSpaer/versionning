...
a.com-latestmembers-memberlist-item {
    margin-right: 5px;
}
...
.ossn-wall-container .controls {
	background-color: #0c9067;
    border-bottom: 1px solid #0c9067;
...
.sidebar-menu-nav ul .sub-menu li:hover, .sidebar-menu-nav li .sub-menu li:hover {
    background-color: #097b58!important;
}
.topbar-menu-right li:hover, .topbar-menu-left li:hover {
    cursor: pointer;
    background-color: #005a3f!important;
}
i.fa.fa-envelope, i.fa.fa-globe, i.fa.fa-users, i.fa.fa-sort-desc {
    margin: 0;
}
...
li.menu-section-links,li.menu-section-groups {
    display: none;
}
...
input.connexion.btn.btn-primary {
    width: 100%;
    background: #097B58;
    border: 1px solid #065039;
    font-weight: bold;
    font-size: 14px;
    height: 38px;
}
button.inscription.btn.btn-danger {
    width: 100%;
    background: #FF0000;
    font-size: 14px;
    font-weight: bold;
